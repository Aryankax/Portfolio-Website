  ...
  return (
    <div className="flex flex-col gap-4 pr-4">
      {items.map((exp, idx) => {
        ...
        return (
          <Reveal key={idx}>
            <div className="rounded-2xl bg-white/12 ring-1 ring-white/20 backdrop-blur-lg px-4 py-3 text-white/95 flex items-start gap-4 shadow-[0_8px_24px_rgba(0,0,0,0.15)]">
              <Icon />
